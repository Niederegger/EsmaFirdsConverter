 ...
 *       &lt;choice>
 *         &lt;element name="ISIN" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}ISINOct2015Identifier"/>
 *         &lt;element name="Indx" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}BenchmarkCurveName2Code"/>
 *         &lt;element name="Nm" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}Max25Text"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BenchmarkCurveName6Choice {
	...
	public L2M getData(String s) {
		L2M l2m = new L2M();
		l2m.append(s+".BenchmarkIsin",isin);
		if(indx!=null)
		l2m.append(s+".BmIndx",indx.toString());
		l2m.append(s+".BmNm",nm);
		return l2m;
	}
