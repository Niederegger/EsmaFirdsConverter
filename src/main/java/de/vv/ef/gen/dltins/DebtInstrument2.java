...
/**
 * <p>Java-Klasse für DebtInstrument2 complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="TtlIssdNmnlAmt" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}ActiveOrHistoricCurrencyAndAmount"/>
 *         &lt;element name="MtrtyDt" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}ISODate" minOccurs="0"/>
 *         &lt;element name="NmnlValPerUnit" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}ActiveOrHistoricCurrencyAndAmount"/>
 *         &lt;element name="IntrstRate" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}InterestRate6Choice"/>
 *         &lt;element name="DebtSnrty" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT6auth.036.001.01}DebtInstrumentSeniorityType1Code" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DebtInstrument2 {
	...
	public L2M getData(String s) {
		L2M l2m = new L2M();
		if(ttlIssdNmnlAmt!=null)l2m.append(ttlIssdNmnlAmt.getData(s+".TtlIssdNmnlAmt"));
