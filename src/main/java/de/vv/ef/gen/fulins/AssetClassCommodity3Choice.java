 ...
 *       &lt;choice>
 *         &lt;element name="Agrcltrl" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityAgricultural1Choice"/>
 *         &lt;element name="Nrgy" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityEnergy1Choice"/>
 *         &lt;element name="Envttl" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityEnvironmental1Choice"/>
 *         &lt;element name="Frtlzr" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityFertilizer1Choice"/>
 *         &lt;element name="Frght" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityFreight1Choice"/>
 *         &lt;element name="IndstrlPdct" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityIndustrialProduct1Choice"/>
 *         &lt;element name="Metl" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityMetal1Choice"/>
 *         &lt;element name="OthrC10" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityOtherC102Choice"/>
 *         &lt;element name="Ppr" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityPaper1Choice"/>
 *         &lt;element name="Plprpln" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityPolypropylene1Choice"/>
 *         &lt;element name="Infltn" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityInflation1"/>
 *         &lt;element name="MultiCmmdtyExtc" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityMultiCommodityExotic1"/>
 *         &lt;element name="OffclEcnmcSttstcs" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityOfficialEconomicStatistics1"/>
 *         &lt;element name="Othr" type="{urn:iso:std:iso:20022:tech:xsd:DRAFT13auth.017.001.01}AssetClassCommodityOther1"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
